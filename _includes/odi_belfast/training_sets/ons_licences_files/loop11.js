...
window["loop11Loader"] = (function () {
    "use strict";
    var devmode = getClientOption("devmode", false),
        domain = getClientOption("loop11domain", "www.loop11.com"),
        cdndomain = getClientOption("loop11cdndomain", "cdn.loop11.com"),
    ...
    var uiLibs = {'triton.1': ['embed.full'],
        'triton.2': ['triton.2']};

    var libUrls;
    if (devmode) {
        libUrls = {'embed.full': cdnBaseUrl + "triton/js/embed.full.js",
            'triton.2': cdnBaseUrl + "triton/js/loop11ui.js",
            'clickview': cdnBaseUrl + "triton/js/clickview_heatmap.js",
            'clickrecord': cdnBaseUrl + "triton/js/clickrecord.js",
            'usertest': cdnBaseUrl + "/triton/js/usertest.js",
            'inject_recorder': cdnBaseUrl + "/triton/js/inject-recorder.js"};
    } else {
        libUrls = {'embed.full': cdnBaseUrl + "triton/js/embed.full.14.js",
            'triton.2': cdnBaseUrl + "triton/js/loop11ui.6.js",
            'clickview': cdnBaseUrl + "triton/js/clickview_heatmap.3.js",
            'clickrecord': cdnBaseUrl + "triton/js/clickrecord.1.js",
            'usertest': cdnBaseUrl + "/triton/js/usertest.10.js",
            'inject_recorder': cdnBaseUrl + "/triton/js/inject-recorder.js"
        };
    }
    ...
    var mode = {
        ...
        sessionItems = ["l11_mode", "l11_uid", "l11_pid", "l11_ot", "l11_oid", "l11_action"],
        session = null,
        json = null,
        crossDomainUrl = {
    ...
    function checkPopup() {
        ...
        if (session !== null && session["l11_mode"] && session["l11_mode"] === mode["popup"]) {
            window["l11_functions"]["addReadyStateHandler"](function(){outputScript(buildSessionUrl());});
        }
    }
        ...
        if (clientOptionPresent("sessiondata")) {
            ...
            for (var i = 0; i < sessionItems.length; i++) {
                ...
                if (name in sessiondata) {
                    if (!sessiondata.hasOwnProperty(name)) { continue; }
    ...
    function handleCrossDomainMessage(evt) {
        if (!devmode && !((/^https?:\/\/[a-z0-9.]+\.loop11\.com/i).test(evt.origin))) { return; }
    ...
    function showPopup(data) {
        ...
        addCss();
        ui = json["ui"] || ui;
        var popupboxData = json["popupbox"];
        ...
        buttons.appendChild(createButton("begin", ui["popupBegin"], json["theme"] ? null : "loop11-begin", null, beginFn));
    ...
    function addCss() {
        ...
        if (themed) {
            styleUrl = tritonBaseUrl + "usertest-style/" + json["session"]["l11_uid"] + "/css";
        } else if (ui["dir"] === "ltr") {
    ...
    function getUIType(ignoreClientOptions) {
        ...
        if (document.readyState !== "complete") {
            ...
            if (navigator.userAgent.match(/android;.*?mobile.*?firefox|android 2[.0-9]+.*version\/4\.0 mobile/gi)) {
                ...
                if (viewportElem = document.querySelector('meta[name="viewport"]')) {
